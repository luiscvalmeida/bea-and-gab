const translations = {
    en: {
        ...
        'main.intro': 'We are so excited to celebrate this special day surrounded by the people we love.',
        ...
        'main.outro': 'Your presence will make our wedding truly unforgettable.',
        ...
        'transport.intro': 'If you’ll need transportation from the venue back to your hotel or home, please indicate this in your RSVP. We will arrange two shuttle departures for guests staying within a 20-minute radius of Quinta de Oleiros — one early and one late — depending on the number of people who need transport. This service is provided at no additional cost.',
        ...
        'rsvp.title': 'RSVP',
        'rsvp.intro': 'Please let us know if you can make it!',
    ...
    fr: {
        ...
        'nav.rsvp': 'RSVP',
        'nav.kids': 'Enfants',
        'nav.dresscode': 'Code Vestimentaire',
        'nav.gifts': 'Cadeaux',
        'main.title': 'Beatriz & Gabriel',
        'main.intro': 'Nous sommes ravis de célébrer ce jour spécial entourés des personnes que nous aimons. Votre présence rendra notre mariage inoubliable.',
        ...
        'rsvp.title': 'RSVP',
        'rsvp.intro': 'Faites-nous savoir si vous pouvez venir !',
        ...
        'dresscode.intro': 'Notre mariage se déroulera en plein air, nous recommandons donc une tenue semi-formelle mais confortable — parfaite pour danser et profiter de la célébration en plein air. Apportez vos chaussures de danse !',
        'gifts.title': 'Cadeaux',
        'gifts.intro': 'Vous avoir avec nous en ce jour spécial est le plus beau cadeau ! 💛',
        'gifts.details': 'Alors que nous commençons notre vie ensemble au Portugal, si vous souhaitez partager vos meilleurs vœux et votre soutien, nous aurons un espace dédié sur le lieu où vous pourrez laisser vos aimables contributions/dons pour nous aider à célébrer ce nouveau chapitre.'
    },
    pt: {
        'nav.home': 'Início',
        ...
        'nav.gifts': 'Presentes',
        'main.title': 'Beatriz & Gabriel',
        'main.intro': 'Estamos muito animados para celebrar este dia especial cercados pelas pessoas que amamos. A vossa presença tornará o nosso casamento verdadeiramente inesquecível.',
        ...
        'rsvp.title': 'RSVP',
        'rsvp.intro': 'Por favor, digam-nos se podem vir!',
        'kids.title': 'Crianças & Bebés 👶',
        'kids.intro': 'Estamos animados para celebrar com todos os nossos entes queridos — e isso inclui os mais pequenos! Crianças e bebés são muito bem-vindos ao nosso casamento.',
        ...
        'dresscode.title': 'Dress Code',
        'dresscode.intro': 'O nosso casamento será ao ar livre, por isso recomendamos semi-formal que seja também confortável — perfeito para dançar e aproveitar a celebração ao ar livre. Tragam os vossos sapatos de dança!',
        'gifts.title': 'Presentes',
        'gifts.intro': 'Ter-vos connosco no nosso dia especial é o maior presente! 💛',
        'gifts.details': 'Ao iniciarmos a nossa vida juntos em Portugal, se quiserem partilhar os vossos melhores votos e apoio, teremos um espaço dedicado no local onde poderão deixar as vossas amáveis contribuições/donativos para nos ajudar a celebrar este novo capítulo.'
    }
};
